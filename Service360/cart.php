...
<section class="shopping-cart">
    ...
    <?php
        $grand_total = 0;
        $select_cart = mysqli_query($conn, "SELECT cart.*, products.location FROM `cart` JOIN `products` ON cart.pid = products.id WHERE cart.user_id = '$user_id'") or die('query failed');
